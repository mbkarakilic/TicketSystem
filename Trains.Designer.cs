namespace TicketSystem
{
	partial class Trains
	{
		...
		private void InitializeComponent()
		{
			...
			trainGrid.Columns.AddRange(new DataGridViewColumn[] { fromColumn, toColumn, dateColumn, timeColumn, companyColumn, priceColumn, busTypeColumn, busBrandColumn });
			trainGrid.Location = new Point(12, 78);
			...
			trainGrid.Size = new Size(643, 238);
			trainGrid.TabIndex = 8;
			trainGrid.Visible = false;
			trainGrid.CellContentClick += BusGridOnClickCellContent;
			// 
			// fromColumn
			// 
