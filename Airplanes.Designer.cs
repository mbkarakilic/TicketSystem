namespace TicketSystem
{
	partial class Airplanes
	{
		...
		private void InitializeComponent()
		{
			...
			((System.ComponentModel.ISupportInitialize)airplaneGrid).BeginInit();
			SuspendLayout();
			// 
			// fromComboBox
			// 
			...
			// airplaneGrid
			// 
			airplaneGrid.AllowUserToAddRows = false;
			airplaneGrid.AllowUserToDeleteRows = false;
			airplaneGrid.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			airplaneGrid.Columns.AddRange(new DataGridViewColumn[] { fromColumn, toColumn, dateColumn, timeColumn, companyColumn, priceColumn });
			airplaneGrid.Location = new Point(12, 78);
			airplaneGrid.Name = "airplaneGrid";
			airplaneGrid.ReadOnly = true;
			airplaneGrid.RowHeadersVisible = false;
			airplaneGrid.SelectionMode = DataGridViewSelectionMode.CellSelect;
			airplaneGrid.Size = new Size(482, 238);
			airplaneGrid.TabIndex = 8;
			airplaneGrid.Visible = false;
			airplaneGrid.CellContentClick += AirplaneGridOnCellContentClick;
			// 
			// fromColumn
			// 
			...
			Name = "Airplanes";
			Text = "Uçaklar";
			((System.ComponentModel.ISupportInitialize)airplaneGrid).EndInit();
			ResumeLayout(false);
			PerformLayout();
		}
		...
		private DataGridView airplaneGrid;
